...
Quite often this is done with model checkers and \ac{smt} solvers.

ARM recently released several of their \acp{isa} in a machine-parsable,
executable format called \ac{asl}.
It took them five years to 
While not directly verifiable, such a format greatly aided in the development of
that is \autocite{reid2016endtoend}.
