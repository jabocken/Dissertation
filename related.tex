...
We subsequently discuss verified compilation and static analysis tools in \cref{se:verified,se:static_analysis}.
...
\begin{table*}
  ...
  \begin{tabular}{lllll}
    ...
    Wartell et al. & No & No & Probabilistic & Hand-picked bins \\
...
Despite all this, a key factor in many decompilation approaches, and also in other approaches that aim at producing control flow graphs or dataflow analyses, is that they rely on the disassembly and control flow recovery being done by an external tool that is assumed to be sound.
...
Previous assembly-, \ac{isa}-, and hardware-level formal verification efforts,
