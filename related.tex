...
Switching tracks to a more categorical representation for the second half of this dissertation, we have the following two \lcnamecrefs{related-lifting}.
...
It received a fully mechanized implementation verified for soundness in Coq\index{Coq}.
...
\begin{comment}
  ...
  and of proof definitions for \gls{isabelle}, HOL4\index{HOL4}, and in some cases Coq\index{Coq},
...
Decompiling Java bytecode to source code was of interest starting in the 90s as well, with tools such as Mocha \autocite{mocha} and Krakatoa \autocite{proebsting1997krakatoa}.
...
Even our Hoare-style work presented in \cref{ch:syntax}, tailored to \gls{memuse} properties, has a ``manual effort vs. instruction count ratio'' of roughly 1 to 11 \cite{verbeek2020automated}.
