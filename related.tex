...
\todo{Add some approaches that use model-checking}

\todo{More static analysis examples?}
...
% Their approach uses Floyd-style verification \autocite{floyd1967assigning}.
\todo{elaborate}
...
\todo{Not much more to say about their methodology, but explaining their case studies would be good. Also mention ACL2, I didn't explicitly state it here}
...
\todo{Maybe talk a little more about this}
...
\todo{Will write about
  \url{https://link.springer.com/chapter/10.1007/978-1-4471-3054-3_35}
once I have access to eduroam/etc.}
...
\section{Dynamic Analysis}\label{se:dynamic}
