...
\todo{Add preamble: give intro then overview/outline first.
  Maybe combine the two if it feels like doing otherwise is too much.}

\todo{give some attribution too}
...
\nomenclature{$\mathbb{W}$}{Type of 64-bit words}%
