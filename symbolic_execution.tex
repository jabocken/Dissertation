...
\nomenclature{$\word$}{Type of 64-bit (unsigned) words}\index{number!word}%
...
\nomenclature{$\coloneqq$} {Indicates a memory write for the \acs*{cfg}/syntax-guided works}
...
\nomenclature{$\esp$}{Type of expressions for \ac*{cfg}/syntax-guided work}
