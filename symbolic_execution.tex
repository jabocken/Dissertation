...
This methodology relies on a formal big-step semantics of the \gls{arch} \gls{isa}
...
They essentially generate memory region \glspl{vc} that must be discharged
