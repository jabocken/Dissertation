...
with the 32-bit representation of~1.
...
The basic rules supplied by the machine model are not always well-suited to verification;
they are often very low-level bitvector/bitstring operations.
% TODO: figure out if this has already been mentioned
