...
The underlined parts are the \emph{reducible expressions},%
\index{reducible expression}
or redexes.\index{redex|see{reducible expression}}
They are the subexpressions not in \emph{normal form},%
\index{normal form}
...
\begin{equation}
  ...
  \nomenclature{$\equiv$}{Indicates expression equivalence;
