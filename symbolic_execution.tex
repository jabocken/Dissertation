...
\begin{subequations}\label{rules_sep_enc}
  \begin{align}
    ...
    r_0\gls{enclosed}r_2\wedge r_1\gls{enclosed}r_3\wedge r_2\gls{separate}r_3 &\longrightarrow r_0\gls{separate}r_1 \\
    r_0\gls{enclosed}r_1\wedge r_1\gls{enclosed}r_0 &\longrightarrow r_0=r_1 \\
    r_0\gls{enclosed}r_1\wedge r_1\gls{enclosed}r_2 &\longrightarrow r_0\gls{enclosed}r_2 \\
