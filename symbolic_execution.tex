...
Flags can only take boolean expressions while398425ff35e378c24791a460b4d242664a6a9775
...
\section{Simplification Rules}\label{se:simplification}
...
Most of those lemmas were obtained from~\citep{memocode2019}.
...
\subsection{Rewrite Rules}\label{memory_rewrite}
...
The underlined parts are the ones that, after application of the rewrite rule,
