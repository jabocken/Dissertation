...
We also do not model \lstinline[language=C++]{setjmp}/\lstinline[language=C++]{longjmp}, as they do not interact well with structured exception handling\cite{using-setjmp-and-longjmp}.
...
We informally argue that the abstract semantics that are symbolically executed overapproximate the concrete semantics~\cite{cousot1996abstract}.
...
%The methodology is informally based on abstract interpretation\cite{cousot1996abstract}, where an abstract transition relation overapproximates concrete transitions.
