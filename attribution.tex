...
as the four papers involved were a significant collaborative effort.
...
This work was also done in collaboration with Dr.~Verbeek, but the contributions are primarily my own.
Some of the basic structure of the implementation was pulled from the previous work (instruction fetching, some aspects of the semantics and basic step function) but everything built on top of that was all new.

\todo{cite unpublished work?}
