...
\abstract{%
  ...
  It narrows the scope of modeling to the \Cpp\ exception handling \ac{abi} and validated that modeling against some of the real-world implementation of that \ac{api} via fuzzing.
