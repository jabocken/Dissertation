...
\abstract{%
  ...
  These two contributions provide \emph{fully-automated} methods of recovering control flow from binaries even in the presence of indirection.
  Indirect control flow that cannot be overapproximatively resolved is noted clearly in the resultant output.
