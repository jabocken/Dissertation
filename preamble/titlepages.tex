...
\abstract{%
  ...
  Narrowing focus to a modeling of exception handling specifically then allows following previously-unknown paths.
  ...
  It narrows the scope of modeling to the \gls{cpp} exception handling \ac{abi} and validated that modeling against some of the real-world implementation of that \ac{api} via fuzzing.
