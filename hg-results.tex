...
Those \namecrefs{sec:not-me-proofs} are credited primarily to Dr.~Freek Verbeek.
...
\begin{enumerate}
  ...
  \item all \glssymbol{bin-total} \gls{arch} binaries and all \glssymbol{lib-func-total} functions from the 25 shared objects we identified in the Xen hypervisor.
