...
\begin{example}
  ...
  Instruction \instref{lst:example-libc}{1168} of that \lcnamecref{lst:example-start} calls \inlineasm{__libc_start_main}.
...
\todo{maybe describe this as an alternative in the Symbolic Execution chapter? Or tie this into the work from \cref{hg}.}
