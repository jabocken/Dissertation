...
\todo{maybe describe this as an alternative in the Symbolic Execution chapter? Or tie this into the work from \cref{ch:hg-lifting,ch:hg-formulation,ch:hg-results,ch:hg-discussion}.}
