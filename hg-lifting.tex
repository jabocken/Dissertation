...
Moving on, below is an example of \iac{hg} and properties of interest within it.
This \namecref{ch:hg-lifting} is followed by an in-depth exploration of the technical formulation of \acp{hg} and their generation (\cref{ch:hg-formulation}).
...
\todo{I already gave organization in the chapter intro, no need to repeat it here}
