...
\acreset{hg} % for now
As we continue moving onward from \todo\dots

In this \namecref{hg} of my dissertation, we introduce an algorithm and tool for the generation of \emph{\acp{hg}}.
...
\subsection{Disassembly Requires Pointer Analysis}
...
\subsection{Disassembly Requires Bounds Analysis}
...
\subsection{Weird Edges are Found}
