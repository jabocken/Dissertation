...
As the programs used in \cref{ch:cfg,ch:syntax} were compiled and run on Linux,\index{linux}
...
\section{Lattices and Their Usage in Programming}\label{lattice-background}
...
\section{Abstract Interpretation}\label{background-absint}
