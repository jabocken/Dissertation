...
As the programs used in \cref{memory-preservation,hg,eicfg} were compiled and run on Linux,\index{linux}
...
Specifically, structured \ac{eh} as utilized by the \Cpp\ \ac{abi}.
