...
By building on the binary analysis tool \texttt{angr}~\citep{shoshitaishvili2016state},%
\index{\texttt{angr}}
...
provided by \citet{roessle2019}\footnote{%
...
and the assembly loaded using the parser of \citet{roessle2019}.
...
akin to Floyd verification~\citep{floyd1967assigning}.%
