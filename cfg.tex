...
and this definition starts with the machine model from \cref{se:machine_model}.
...
It requires a tuple of instruction to execute as well as the current state~$\sigma$,
