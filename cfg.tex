...
An advantage of this, however, is that a proof over a recursive function
essentially requires showing termination
and thus the avoidance of stack overflows\footnote{%
  On a conceptual level, at least. Most modern language runtimes and \acp{os}
  put limits on stack size as sanity checks;
  this can be handled in control-flow-driven verification
  by adding additional assumptions to the analysis.
}.
