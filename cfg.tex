...
mentioned in \cref{se:cfg_overview}. The input is stored in \inlineasm{edi}.
\begin{lstlisting}[
  language=C,
  gobble=2,
  float=*,
...
stored in~\inlineasm{dil} (the lowest eight bits of~\inlineasm{edi}/\rdi).
\begin{lstlisting}[
  style=x64,
...
This is done by instantiating variable~$n$ with \inlineasm{dil}.
