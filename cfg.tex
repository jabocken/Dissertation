...
\tikzstyle{myblock} = [rectangle, draw, text width=2.5cm, text centered, rounded corners, minimum height=2cm]
\begin{figure}
  \centering
...
Internal composition is simply a more formal refomulation
...
\begin{proof}
  ...
  \Cref{thm:comp} can then be used
...
\begin{figure}
  ...
  \begin{tikzpicture}[>={stealth}]
    \graph[math nodes, grow down=2.2cm]{
      ...
      ] c/"\retaddr:\readmem{a}{1}=v_0\wedge\mathrsp=\rspo+8";
