...
% Get rid of introduction somehow (move some to preamble, change section name to overview?)
...
\begin{figure}
  ...
  \begin{tikzpicture}[node distance=4.5cm, auto, ->, >=stealth, myblock/.style={
    ...
    \node[myblock, right of=binary, minimum height=1cm] (cfg) {Python script};
...
\section{Function-level Composition}\label{se:composition}
