...
It is designed for the proving of memory usage%
\index{memory!usage}
...
My three main contributions to the memory usage work presented here were:
\begin{enumerate*}
...
is generally a hard task, but targeting a property such as memory usage
...
\begin{enumerate*}
  ...
  \item finishing the proof of memory usage.
\end{enumerate*}
...
of memory usage in \gls{arch} binaries,
...
Requirements for memory usage invariants were provided for several examples.
