...
The rest of this chapter provides formal definitions
of the chapter-specific properties in \cref{se:cfg_defs}
and an example of application to a recursive function in \cref{sse:factorial_example}.
...
\begin{definition}[Hoare triple for memory usage]\label{def:htriple}
  ...
  the function call $\run(H,\sigma)$
  produces a non-exceptional state that satisfies postcondition~$Q$.
