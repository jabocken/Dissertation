...
fully described in \cref{memory_preservation}.
...
\subsection{Memory Preservation}\label{sse:mem_pres}
...
Memory preservation formulates any byte not within any of the regions in~$M$
