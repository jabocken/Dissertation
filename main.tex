...
\usepackage[index,single]{acro}                  % For acronyms; hyperref option doesn't work right with XeLaTeX so not using it right now
...
\abstract{%
  Give a brief description of your thesis here.
  Max of 250 words for a master's thesis and 350 words for a PhD dissertation,
  according to the VT ETD standards.%
}
