...
%  \maketitle
  ...
  \part{Work Leading up to the Preliminary Exam}\label{prelim}
  \include{cfg}
  \include{syntax}
  ...
  \part{\emph{Exceptional Interprocedural Control Flow Graphs}}\label{eicfg}
  \include{eicfg}
  \include{eicfg-formulation}
  \include{eicfg-validation}
  \include{eicfg-conclusion}
