...
% for acmart class, use \renewcommand instead of \providecommand
\makeatletter
...
\DeclareMathOperator{\AWhile}{Loop}
\DeclareMathOperator{\AOd}{Pool}
\DeclareMathOperator{\AIf}{If}
\DeclareMathOperator{\AThen}{Then}
\DeclareMathOperator{\AElse}{Else}
\DeclareMathOperator{\AFi}{Fi}
\DeclareMathOperator{\ABB}{Block}
\DeclareMathOperator{\ASkip}{Skip}
\DeclareMathOperator{\ACall}{Call}
\DeclareMathOperator{\ABreak}{Break}
\DeclareMathOperator{\AContinue}{Continue}
\DeclareMathOperator{\AWhileResume}{Resume}
\DeclareMathOperator{\stmts}{stmts}

\DeclarePairedDelimiter{\takebits}{\langle}{\rangle}
\DeclarePairedDelimiter{\abs}{\lvert}{\rvert}

\newcommand{\Block}[2]{\mathtt{#1-\!\!\!>\!\!#2}}
...
\begin{document}
  ...
  \tableofcontents
	...
	\listoffigures
  \listoftables
  \addtocfix{List of Algorithms}{\listofalgorithms}
  \addtocfix{\lstlistlistingname}{\lstlistoflistings}
