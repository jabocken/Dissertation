...
%  \maketitle
  ...
  % Freek doesn't think the numbers one is worth it. I was mainly using it for the cross-referencing anyway but that's okay, maybe it'll end up in the ``main''/index glossary? How do I manage that?
