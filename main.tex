...
\DeclareMathOperator{\rbxpops}{multiplicandsPushed}
\DeclareMathOperator{\retsites}{retAddrsPushed}
\DeclareMathOperator{\retaddress}{retAddress}
...
\begin{document}
  ...
  \microtypesetup{protrusion=false} % avoiding potential line length alterations in the lists
  \tableofcontents
  \listoffigures
  \listoftables
  \listofalgorithms
