...
\DeclareMathOperator{\insertM}{ins}
\newcommand*{\cons}{\mathbin{:}}
\newcommand*{\sepdot}{\cdot}

\newcommand{\comparable}{\mathrel{\mathbf{C}}}
...
\includeonly{hg-formulation}

% This isn't working but whatever
\newcommand\nomenclature[2]{}
...
%  \maketitle
  ...
  \printunsrtglossary[type=symbols,style=indexgroup] % no default style for symbols; don't know why they aren't being formatted here
  \acresetall % Any acronyms used inside the glossaries should start over here.
  ...
  \part{Adaptations From and Extensions to \emph{Formally Verified Lifting of C-compiled x86-64 Binaries}}
  \include{hg-lifting}
  \include{hg-formulation}
  \include{hg-results}
  \include{hg-discussion}

  \part{Adaptations From and Extensions to \emph{Exceptional Interprocedural Control Flow Graphs}}
  \include{eicfg}
  ...
  {% appendices don't work right with \backmatter due to it getting rid of counters
    ...
    \printindex % may be getting rid of this soon...
    \printunsrtglossary[style=bookindex] % default style not good for index
  }
