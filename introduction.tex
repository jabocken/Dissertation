...
Even pen-and-paper proofs can provide guarantees that informal analysis does not.

Furthermore, while formal verification of software has been an active field of research for over fifty years, there are still plenty of gaps.
The gaps we have uncovered lie in the areas of trustworthy memory analysis and trustworthy control flow lifting.
