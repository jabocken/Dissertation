...
\todo{maybe take a similar approach to Rob's dissertation, where he integrated the related work into the motivation/start of the introduction? maybe not}
...
For our purposes, the field of \emph{formal verification}\index{formal!verification} specifically.
...
% basic challenges
However, many such properties are \emph{undecidable} \autocite{rice1953classes,horspool1980approach,ouimet2008formal}.
...
\todo{what is binary analysis and why is it useful?}
...
\todo{integrate this into motivation?}
...
\section{Impact}
\todo{What are the results? What can these contributions be used for?}
