...
\Ac{cots} tools such as Ghidra \autocite{ghidra}, IDA Pro \autocite{ida-decompiler}, and Binary Ninja \autocite{binary-ninja-decompiler} often integrate or offer as a plugin such a decompiler as well.
...
binary verification \autocite{goelphd,brumley2011bap,tan2015auspice}

\subsubsection{Patching}
binary patching \autocite{wartell2012binary,kim2017revarm}
