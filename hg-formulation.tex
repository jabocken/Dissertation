...
\begin{algorithm}
  \caption{Base version of \acs*{hg} extraction}
  \label{alg:invgen}
...
To formulate soundness and present a proof, we first define a relation \gls{related} between the concrete transition system and the \ac{hg}.
...
\begin{definition}[\Acs*{hg} soundness]
