...
\subsection{Integrating \Acs*{cfr} into Formal Frameworks}
...
However, while the \acp{hg} we generate can be validated in \gls{isabelle}, this validation is a manual approach.
