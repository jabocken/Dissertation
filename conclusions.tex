...
Furthermore, we have applied our \ac{eicfg} generator to \glssymbol{total-bins} real-world programs and libraries.
...
\subsection{Integrating Later Contributions into Formal Frameworks}
...
However, while some of the \acp{hg} we generated have been validated, this validation is a manual approach.
